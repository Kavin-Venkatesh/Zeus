  ...
  methods: {
    async submitForm() {
      ...
      password: this.password
        ...
        this.$toast.add({ severity : 'success', summary : 'Login Sucessful' , detail :'Logged in Successfully', life : 3000})
        ...
        console.error(error);
        this.$toast.add({ severity: 'error', summary: 'Login Failed', detail: 'Please check your credentials and try again', life: 3000 });
      }
    }
  },
